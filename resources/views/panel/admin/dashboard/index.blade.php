                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a href="#collapseOne" data-parent="#accordion" data-toggle="collapse" class="accordion-toggle padding-15">
                                                ...
                                                This Month <span class="label label-danger pull-left">3</span>
                                            </a></h4>
                                    </div>
                    ...
                    <div class="panel panel-white no-radius">
                        ...
                        <div class="panel-body no-padding">
                            <div class="padding-10">
                                <img width="50" height="50" src="assets/images/avatar-1.jpg" class="img-circle pull-right" alt="">
                            ...
                            <div class="tabbable no-margin no-padding">
                                <ul class="nav nav-tabs" id="myTab">
                                    <li class="active padding-top-5 padding-right-5">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="panel panel-white no-radius">
                        ...
                        <div class="panel-body no-padding">
                            <div class="panel-scroll height-330" id="chatBox">
                                <ol class="discussion">
